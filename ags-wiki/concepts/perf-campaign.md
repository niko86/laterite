...
- **The read door holds ~11×-of-input across the ladder** (13.77× at 5 MB
  ...
  carries the numbers). Throughput *rises* with the rung
  (158 → 201 MB/s) as the fixed spawn cost amortises.
