...
`laterite-ags4-reference` reference-data leaf, and the `laterite-ags4-core`
DuckDB-free core are now swept; near-term Rust queue (tracks
[[coverage-campaign]]'s): the remaining engine crates —
`laterite-ags4-validator`, `laterite-ags4-emit`.
