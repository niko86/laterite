...
repo_refs:
  ...
  census_args_gate: "repo:rust-packages/laterite-ags4-check/src/commands/census.rs::census_knows_which_flags_take_a_value"
  ...
  output_value_gate: "repo:rust-packages/ags4-compliance/src/bin/xcheck.rs"
  verb_coverage_gate: "repo:tests/test_xcheck_verb_coverage.py"
  fix_repaired_test: "repo:tests/test_xcheck_fix_repaired.py"
  four_laterite_tuple_floor: "repo:rust-packages/ags4-compliance/src/main.rs"
...
|---|---|---|---|
| `repo:observations.json` | `repo:tools/gen_observations.py` | `repo:OBSERVATIONS.md` | `repo:tests/test_observations_faithful.py` |
| `repo:rust-packages/laterite-ags4-validator/data` (5 official `.ags`) | `repo:tools/gen_dictionary.py` | `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json` | `repo:tests/test_dictionary_faithful.py` |
| `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json` | `repo:tools/gen_sensitive_headings.py` | `repo:rust-packages/laterite-ags4-core/data/sensitive_headings.json` | `repo:tests/test_sensitive_headings_faithful.py` |
...
| the vault filesystem | `repo:ags-wiki/.bootstrap/reindex.py` | `repo:ags-wiki/index.md` | `repo:tests/test_wiki_index_faithful.py` |
| `repo:modality.json` | `repo:tools/gen_modality.py` | `repo:ags-wiki/concepts/modality-register.md` | `repo:tests/test_modality_faithful.py` |
| `repo:rust-packages/laterite-ags4-check/README-cli.md` (== `lat --readme`) | `repo:tools/gen_wiki_cli.py` | `repo:ags-wiki/tools/laterite-ags4-check.md` (verb-table block) | `repo:tests/test_wiki_cli_faithful.py` |
| `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json` | `repo:tools/gen_reference_groups.py` | `repo:ags-wiki/groups/*.md` (one page per dict group; the whole reference tier, D6) | `repo:tests/test_reference_groups_faithful.py` |
| `repo:rust-packages/Cargo.toml` (+ each member manifest) | `repo:tools/gen_crate_graph.py` | `repo:ags-wiki/concepts/crate-dependency-graph.md` (the complete crate graph; its Cargo-dep read is also asserted `== lint.py::_crate_deps()` so the two manifest readers can't drift) | `repo:tests/test_crate_graph_faithful.py` |
| `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json` | — (shipped group count pinned, not rendered) | keystone pages' "N groups / typed-graph classes" facts (`repo:ags-wiki/start-here.md`, `repo:ags-wiki/AGS-WIKI.md`, `repo:ags-wiki/tools/laterite-ags4-core.md`, `repo:ags-wiki/tools/laterite-node.md`, `repo:ags-wiki/sources/repo-authorities/ags-dictionary-json.md`) | `repo:tests/test_numeric_facts_faithful.py` |
| `repo:tools/vendor/laterite-duckdb-functions.json` (a pinned vendored copy of the `laterite_ags4` extension's own `functions.json`, gated upstream against its `register_table()` calls) | — (docs gated, not rendered) | `repo:web/docs-site/docs/reference/duckdb-functions.md` + `repo:modality.json` duckdb cells | `repo:tests/test_duckdb_surface_faithful.py` |
...
files currently say*. The content gate for that row is
`repo:tests/test_vendored_authority_faithful.py`: the five files byte-for-byte
...
- ags4-output-value-gate — the general cross-surface output-VALUE gate (#519–525), sharing a crate with ags4-compliance
