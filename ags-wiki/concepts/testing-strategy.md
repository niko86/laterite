...
| `repo:rust-packages/laterite-ags4-check/README-cli.md` (== `lat --readme`) | `repo:tools/gen_wiki_cli.py` | `repo:ags-wiki/tools/laterite-ags4-check.md` (verb-table block) | `repo:.github/workflows/wiki-lint.yml` (`gen_wiki_cli.py --check`) |
