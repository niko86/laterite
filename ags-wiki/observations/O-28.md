---
type: observation
title: "O-28 — External `--dict` custom-dictionary override — deferred at V8, implemented in laterite-dev#568"
status: reviewed
tags: [observation]
observation_id: O-28
obs_tag: VARIANCE
...
sources: []
---
# O-28 — External `--dict` custom-dictionary override — deferred at V8, implemented in laterite-dev#568
...
> flag was plumbed but refused with a `BadDict` error. **laterite-dev#568** shipped it
