...
> Source-of-truth is `repo:observations.json` (record O-45), rendered to
> `repo:OBSERVATIONS.md#o-45` — never hand-edit the Markdown.
...
Source-of-truth (never pasted): `repo:observations.json`, record O-45 — rendered at `repo:OBSERVATIONS.md#o-45`.
