...
> Source-of-truth is `repo:observations.json` (record O-42), rendered to
> `repo:OBSERVATIONS.md#o-42` — never hand-edit the Markdown.
...
Source-of-truth (never pasted): `repo:observations.json`, record O-42 — rendered at `repo:OBSERVATIONS.md#o-42`.
