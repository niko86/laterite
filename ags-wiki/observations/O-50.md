---
type: observation
title: "O-50 — 0DP integer CONVERSION: laterite range-guards an out-of-i64 value to Null (#611, was a fabricated i64::MAX); both validators already flag it, python-ags4's conversion keeps full precision"
status: drafted
tags: [observation]
observation_id: O-50
obs_tag: VARIANCE
...
> Source-of-truth is `repo:OBSERVATIONS.md#o-50`.
...
> `9223372036854775807` — a wrong number that was never in the file. #611
...
> preservation was considered and deferred. #611 also finishes the #531
...
Source-of-truth (never pasted): `repo:OBSERVATIONS.md#o-50`.
...
> (silent saturation). #611 fixes it on our side; recorded for our own
