...
> Source-of-truth: `repo:observations.json` (record O-36), rendered at `repo:OBSERVATIONS.md#o-36`.
...
Source-of-truth (never pasted): `repo:observations.json`, record O-36 — rendered at `repo:OBSERVATIONS.md#o-36`.

> [!note] The "non-zero default sample" follow-up is generalised by the
> adaptive [[parity-confidence-model]] in [[laterite-ags4-forge]]: a per-class
