...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=TNPC]"
...
## Purpose
> [!quote] The **TNPC** group — Ten Per Cent Fines. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=TNPC]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `TNPC_TESN` | OTHER | `X` | Test reference |
| `TNPC_DRY` | OTHER | `X` | 10% fines values on dry aggregate |
| `TNPC_WET` | OTHER | `X` | 10% fines values on wet aggregate |
| `TNPC_REM` | OTHER | `X` | Remarks |
| `TNPC_METH` | OTHER | `X` | Test method |
| `TNPC_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `TNPC_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `TNPC_DEV` | OTHER | `X` | Deviation from the specified procedure |
