---
type: group
title: ASNS — Aggregate Soundness Tests
status: drafted
tags: [group]
group_code: ASNS
parent: SAMP
...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=ASNS]"
...
## Purpose
> [!quote] The **ASNS** group — Aggregate Soundness Tests. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=ASNS]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `ASNS_SOUN` | OTHER | `0DP` | Aggregate soundness test |
| `ASNS_FRAC` | OTHER | `X` | Size fraction from which test portion was obtained |
| `ASNS_REM` | OTHER | `X` | Remarks |
| `ASNS_METH` | OTHER | `X` | Test method |
| `ASNS_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `ASNS_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `ASNS_DEV` | OTHER | `X` | Deviation from the specified procedure |
