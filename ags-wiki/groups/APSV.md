---
type: group
title: APSV — Aggregate Polished Stone Tests
status: drafted
tags: [group]
group_code: APSV
parent: SAMP
...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=APSV]"
...
## Purpose
> [!quote] The **APSV** group — Aggregate Polished Stone Tests. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=APSV]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `APSV_AAV` | OTHER | `0DP` | Aggregate polished stone value |
| `APSV_REM` | OTHER | `X` | Remarks |
| `APSV_METH` | OTHER | `X` | Test method |
| `APSV_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `APSV_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `APSV_DEV` | OTHER | `X` | Deviation from the specified procedure |
