---
type: group
title: ACVT — Aggregate Crushing Value Tests
status: drafted
tags: [group]
group_code: ACVT
parent: SAMP
...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=ACVT]"
...
## Purpose
> [!quote] The **ACVT** group — Aggregate Crushing Value Tests. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=ACVT]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `ACVT_ACV` | OTHER | `0DP` | Aggregate Crushing Value |
| `ACVT_FRAC` | OTHER | `X` | Size fraction from which test portion was obtained |
| `ACVT_REM` | OTHER | `X` | Remarks |
| `ACVT_METH` | OTHER | `X` | Test method |
| `ACVT_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `ACVT_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `ACVT_DEV` | OTHER | `X` | Deviation from the specified procedure |
