---
type: group
title: AWAD — Aggregate Water Absorption Tests
status: drafted
tags: [group]
group_code: AWAD
parent: SAMP
...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=AWAD]"
...
## Purpose
> [!quote] The **AWAD** group — Aggregate Water Absorption Tests. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=AWAD]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `AWAD_WTAB` | OTHER | `1DP` | Aggregate water absorption |
| `AWAD_REM` | OTHER | `X` | Remarks |
| `AWAD_METH` | OTHER | `X` | Test method |
| `AWAD_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `AWAD_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `AWAD_DEV` | OTHER | `X` | Deviation from the specified procedure |
