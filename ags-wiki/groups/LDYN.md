...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=LDYN]"
...
## Purpose
> [!quote] The **LDYN** group — Dynamic Testing. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=LDYN]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `LDYN_PWAV` | OTHER | `0DP` | P-wave velocity |
| `LDYN_SWAV` | OTHER | `0DP` | S-wave velocity |
| `LDYN_EMOD` | OTHER | `0DP` | Dynamic elastic modulus |
| `LDYN_SG` | OTHER | `0DP` | Shear modulus derived from LDYN_SWAV |
| `LDYN_REM` | OTHER | `X` | Remarks |
| `LDYN_METH` | OTHER | `X` | Test method |
| `LDYN_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `LDYN_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `LDYN_DEV` | OTHER | `X` | Deviation from the specified procedure |
