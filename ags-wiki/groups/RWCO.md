---
type: group
title: RWCO — Water Content of Rock Tests
status: drafted
tags: [group]
group_code: RWCO
parent: SAMP
...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=RWCO]"
...
## Purpose
> [!quote] The **RWCO** group — Water Content of Rock Tests. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=RWCO]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `RWCO_MC` | OTHER | `X` | Water content |
| `RWCO_TEMP` | OTHER | `0DP` | Temperature sample dried at |
| `RWCO_REM` | OTHER | `X` | Remarks |
| `RWCO_METH` | OTHER | `X` | Test method |
| `RWCO_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `RWCO_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `RWCO_DEV` | OTHER | `X` | Deviation from the specified procedure |
