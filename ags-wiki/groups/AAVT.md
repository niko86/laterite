---
type: group
title: AAVT — Aggregate Abrasion Tests
status: drafted
tags: [group]
group_code: AAVT
parent: SAMP
...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=AAVT]"
...
## Purpose
> [!quote] The **AAVT** group — Aggregate Abrasion Tests. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=AAVT]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `AAVT_AAV` | OTHER | `2SF` | Aggregate Abrasion Value |
| `AAVT_REM` | OTHER | `X` | Remarks |
| `AAVT_METH` | OTHER | `X` | Test method |
| `AAVT_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `AAVT_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `AAVT_DEV` | OTHER | `X` | Deviation from the specified procedure |
