---
type: group
title: AELO — Aggregate Elongation Index Tests
status: drafted
tags: [group]
group_code: AELO
parent: SAMP
...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=AELO]"
...
## Purpose
> [!quote] The **AELO** group — Aggregate Elongation Index Tests. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=AELO]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `AELO_EI` | OTHER | `0DP` | Aggregate elongation index |
| `AELO_REM` | OTHER | `X` | Remarks |
| `AELO_METH` | OTHER | `X` | Test method |
| `AELO_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `AELO_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `AELO_DEV` | OTHER | `X` | Deviation from the specified procedure |
