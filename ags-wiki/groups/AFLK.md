---
type: group
title: AFLK — Aggregate Flakiness Tests
status: drafted
tags: [group]
group_code: AFLK
parent: SAMP
...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=AFLK]"
...
## Purpose
> [!quote] The **AFLK** group — Aggregate Flakiness Tests. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=AFLK]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `AFLK_FI` | OTHER | `0DP` | Aggregate flakiness index |
| `AFLK_MASS` | OTHER | `1DP` | Mass of test portion |
| `AFLK_REM` | OTHER | `X` | Remarks |
| `AFLK_METH` | OTHER | `X` | Test method |
| `AFLK_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `AFLK_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `AFLK_DEV` | OTHER | `X` | Deviation from the specified procedure |
