---
type: group
title: LLIN — Linear Shrinkage Tests
status: drafted
tags: [group]
group_code: LLIN
parent: SAMP
...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=LLIN]"
...
## Purpose
> [!quote] The **LLIN** group — Linear Shrinkage Tests. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=LLIN]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `LLIN_LS` | OTHER | `0DP` | Linear shrinkage |
| `LLIN_425` | OTHER | `0DP` | Percentage passing 0.425mm sieve |
| `LLIN_PREP` | OTHER | `X` | Method of preparation |
| `LLIN_REM` | OTHER | `X` | Remarks |
| `LLIN_METH` | OTHER | `X` | Test method |
| `LLIN_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `LLIN_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `LLIN_DEV` | OTHER | `X` | Deviation from the specified procedure |
