---
type: group
title: RSHR — Shore Scleroscope Hardness Tests
status: drafted
tags: [group]
group_code: RSHR
parent: SAMP
...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=RSHR]"
...
## Purpose
> [!quote] The **RSHR** group — Shore Scleroscope Hardness Tests. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=RSHR]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `RSHR_SHOR` | OTHER | `1DP` | Average Shore hardness value |
| `RSHR_AXIS` | OTHER | `X` | Orientation of the test surface relative to bedding |
| `RSHR_NUM` | OTHER | `0DP` | Number of tests conducted |
| `RSHR_REM` | OTHER | `X` | Remarks |
| `RSHR_METH` | OTHER | `X` | Test method |
| `RSHR_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `RSHR_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `RSHR_DEV` | OTHER | `X` | Deviation from the specified procedure |
