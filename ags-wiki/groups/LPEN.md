---
type: group
title: LPEN — Laboratory Hand Penetrometer Tests
status: drafted
tags: [group]
group_code: LPEN
parent: SAMP
...
repo_refs:
  dictionary: "repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=LPEN]"
...
## Purpose
> [!quote] The **LPEN** group — Laboratory Hand Penetrometer Tests. It is a **child of [[SAMP]]** in the PROJ-rooted hierarchy. See [[parent-child-graph]].
...
## Headings
> [!quote] Rendered from `repo:rust-packages/laterite-ags4-reference/data/ags_dictionary.json groups[code=LPEN]` (the repo's model authority — AGS edition 4.2). Suggested UNITs + worked examples are in the cited spec PDF, not duplicated here.
...
| `LPEN_PPEN` | OTHER | `0DP` | Hand penetrometer undrained shear strength |
| `LPEN_MC` | OTHER | `X` | Water/moisture content local to test, if measured |
| `LPEN_REM` | OTHER | `X` | Remarks |
| `LPEN_METH` | OTHER | `X` | Test method |
| `LPEN_LAB` | OTHER | `X` | Name of testing laboratory/organization |
| `LPEN_CRED` | OTHER | `X` | Accrediting body and reference number (when appropriate) |
| `TEST_STAT` | OTHER | `X` | Test status |
| `FILE_FSET` | OTHER | `X` | Associated file reference (e.g. test result sheets) |
| `SPEC_BASE` | OTHER | `2DP` | Depth to base of specimen |
| `LPEN_DEV` | OTHER | `X` | Deviation from the specified procedure |
