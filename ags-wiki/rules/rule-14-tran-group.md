...
repo_refs:
  ...
  fixtures: ""
  regression: ""
  spec: "spec:AGS4-4.2-2025.pdf §4.1.1 Rule 14"
...
## Statement
> [!quote] AGS4 Rule 14 — `spec:AGS4-4.2-2025.pdf §4.1.1 Rule 14`
...
[[TRAN]] present, exactly one DATA row, REQUIRED filled. Zero-row TRAN also Rule 2 (O-16).
...
```mermaid
flowchart LR
  R["Rule 14"] --> I["groups.rs"] --> F["0 fixture(s)"] --> T["0 test(s)"] --> O["O-N (linked at Ingest)"]
```
