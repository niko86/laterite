...
> The DATA DESCRIPTORS, GROUP names, data field HEADINGs, data field UNITs, data field TYPEs, and data VARIABLEs in each line shall be separated by a comma (,). No carriage returns (ASCII 13) or line feeds (ASCII 10) are allowed in or between data VARIABLEs within a DATA row.
