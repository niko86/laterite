...
3. **The engine fingerprint covers the validator's own source + data, and — since
   ...
   uncovered verdict-determining paths: `laterite-types` (owns `format_nsf`, which
