...
(the dated perf-matrix report of 2026-06-18, in the dev archive outside this
repo). The ~5 MB/s was a property of
...
- **The fix is visible in the matrix** (the dated perf-matrix report of
  2026-06-19, in the dev archive outside this repo):
