...
## Definition
> [!quote] AGS4 TYPE `PT` — `spec:AGS4-4.2-2025.pdf §3.3`
> Text listed in the TYPE Group (Rule 17). Case sensitive.

## Canonical mapping
Maps to `CanonicalType.string` — cite `repo:packages/laterite/python/laterite/ags_types.py::canonical_type`.

## Validation (Rule 8)
> [!quote] Text; membership is Rule 17 (TYPE group). Case-sensitive (§3.3).
