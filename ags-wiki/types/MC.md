...
## Definition
> [!quote] AGS4 TYPE `MC` — `spec:AGS4-4.2-2025.pdf §3.3`
> BS 1377:Part 2 reported moisture content. **Included for legacy reasons and NOT used in AGS 4.2.**

## Canonical mapping
Maps to `CanonicalType.string` — cite `repo:packages/laterite/python/laterite/ags_types.py::canonical_type`.

## Validation (Rule 8)
> [!quote] Legacy-dead (§3.3: 'not used in AGS 4.2' — [[type-mc-legacy-dead]]); Rule 8 would still classify it if encountered. A model-debt smell, not a live validation path.
