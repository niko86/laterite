...
> [!note] **Cleared for crates.io** — `laterite-ags4-validator` v0.9.0 (inherited from the workspace) declares `publish = true`, so it is a public API under semver, not an internal detail.
