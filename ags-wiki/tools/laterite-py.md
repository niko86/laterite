...
> [!note] **Internal implementation detail** — the native cdylib, not a
> public API. External developers use the [[laterite]] wheel; this crate
> is the compiled `_laterite_native` module behind it.
