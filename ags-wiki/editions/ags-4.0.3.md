...
## Overview
AGS **4th Edition Addendum 3** — released 2011-10-01, status **deprecated**. Spec PDF: `spec:AGS4-4.0.3-*.pdf` (vault root). Addendum to 4.0.2. Earliest edition in scope. Rule prose as in 4.2 §4.1.1 (frozen).
