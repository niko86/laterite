...
## Usage
    ...
    ags4-check <file.ags> [options]
    ags4-check --readme        # this document
...
## Examples
    ...
    ags4-check delivery.ags                 # human table
    ags4-check delivery.ags --json | jq .   # machine-readable
    ags4-check delivery.ags --dict-version 4.2   # force an edition
    ags4-check delivery.ags --show-fyi --out report.txt
