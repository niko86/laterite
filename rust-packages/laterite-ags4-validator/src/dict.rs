...
impl DictVersion {
    pub fn as_str(self) -> &'static str {
        match self {
            DictVersion::V4_0_3 => "4.0.3",
            DictVersion::V4_0_4 => "4.0.4",
            DictVersion::V4_1 => "4.1",
            DictVersion::V4_1_1 => "4.1.1",
            DictVersion::V4_2 => "4.2",
        }
    }
}
...
/// The edition auto-selection falls back to when a file's `TRAN_AGS`
/// is absent / unparsable / an unrecognised 4.x. Deliberately matched
/// to python-ags4's `LATEST_DICT_VERSION` so dogfood parity reflects
/// real defects, not fallback artefacts. (AGS 3.x hard-fails instead —
/// see `resolve_dict_version`.)
pub const FALLBACK: DictVersion = DictVersion::V4_1_1;

// Generated by build.rs into OUT_DIR. Defines, per version:
//   static DICT_4_1_HEADINGS:       phf::Map<&str, DictEntry>
//   static DICT_4_1_GROUPS:         phf::Map<&str, GroupMeta>
//   static DICT_4_1_GROUP_HEADINGS: phf::Map<&str, &[&str]>
//   static DICT_4_1_TRAN_AGS:       &str
//   (and the 4_2 set)
...
impl Dictionary {
    pub fn bundled(version: DictVersion) -> Self {
        match version {
            DictVersion::V4_0_3 => Dictionary {
                headings: &DICT_4_0_3_HEADINGS,
                groups: &DICT_4_0_3_GROUPS,
                group_headings: &DICT_4_0_3_GROUP_HEADINGS,
                abbrs: &DICT_4_0_3_ABBRS,
                tran_ags: DICT_4_0_3_TRAN_AGS,
                version,
            },
            DictVersion::V4_0_4 => Dictionary {
                headings: &DICT_4_0_4_HEADINGS,
                groups: &DICT_4_0_4_GROUPS,
                group_headings: &DICT_4_0_4_GROUP_HEADINGS,
                abbrs: &DICT_4_0_4_ABBRS,
                tran_ags: DICT_4_0_4_TRAN_AGS,
                version,
            },
            DictVersion::V4_1 => Dictionary {
                headings: &DICT_4_1_HEADINGS,
                groups: &DICT_4_1_GROUPS,
                group_headings: &DICT_4_1_GROUP_HEADINGS,
                abbrs: &DICT_4_1_ABBRS,
                tran_ags: DICT_4_1_TRAN_AGS,
                version,
            },
            DictVersion::V4_1_1 => Dictionary {
                headings: &DICT_4_1_1_HEADINGS,
                groups: &DICT_4_1_1_GROUPS,
                group_headings: &DICT_4_1_1_GROUP_HEADINGS,
                abbrs: &DICT_4_1_1_ABBRS,
                tran_ags: DICT_4_1_1_TRAN_AGS,
                version,
            },
            DictVersion::V4_2 => Dictionary {
                headings: &DICT_4_2_HEADINGS,
                groups: &DICT_4_2_GROUPS,
                group_headings: &DICT_4_2_GROUP_HEADINGS,
                abbrs: &DICT_4_2_ABBRS,
                tran_ags: DICT_4_2_TRAN_AGS,
                version,
            },
        }
    }
