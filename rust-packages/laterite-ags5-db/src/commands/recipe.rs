//! `lat-db recipe [name] [--group X]` — print a query template by name,
...
use laterite_ags5_db::recipes::{Recipe, load_all, substitute_group};
use laterite_ags5_db::suggest::suggest;
use serde::Serialize;
