...
//! here from `laterite-ags4-validator/build.rs` (laterite-dev#475 PR2) so a consumer that
...
fn main() {
    ...
    // The union JSON now lives in this leaf's own data/ (laterite-dev#475 PR2 relocated it
