...
__version__ = f"0.8.1+compat.python-ags4.{PYTHON_AGS4_COMPAT}"

# Human-readable Metadata.Checker — same intent, prose form.
_CHECKER_STRING = "laterite 0.8.1 — compat: python-ags4 1.2.0 — clean-room laterite_ags4_validator engine"
