...
def ags4_bytes_to_xlsx(data: Any, ordered_keys: Any = ...) -> Any: ...
def ags4_to_excel(input_file: Any, output_file: Any, ordered_keys: Any = ...) -> Any: ...
def canonical_type(ags_type: Any) -> Any: ...
def dict_group_unit_type(edition: Any, group: Any) -> Any: ...
def diff_files(a: Any, b: Any, dict_version: Any = ..., encoding: Any = ...) -> Any: ...
def display_hint(ags_type: Any) -> Any: ...
def emit_ags4_compat(tables: Any) -> Any: ...
def emit_ags4_from_arrow(tables: Any, edition: Any = ..., mode: Any = ..., units: Any = ..., types: Any = ...) -> Any: ...
def excel_to_ags4(input_file: Any, output_file: Any, format_numeric_columns: Any = ...) -> Any: ...
def fix_file(path: Any = ..., text: Any = ..., data: Any = ..., dict_version: Any = ..., encoding: Any = ..., include_risky: Any = ..., only: Any = ..., exclude: Any = ...) -> Any: ...
def list_rules() -> Any: ...
def merge_files(files: Any, lenient: Any = ..., dict_version: Any = ..., encoding: Any = ..., tran_issue: Any = ..., tran_date: Any = ..., tran_producer: Any = ..., tran_recipient: Any = ..., tran_status: Any = ...) -> Any: ...
def parse_arrow(path: Any = ..., text: Any = ..., data: Any = ..., encoding: Any = ...) -> Any: ...
def parse_primitives(path: Any = ..., text: Any = ..., data: Any = ..., encoding: Any = ...) -> Any: ...
def parse_value(raw: Any, ags_type: Any) -> Any: ...
def read_groups_raw(path: Any) -> Any: ...
def registry_ancestor_chain(code: Any) -> Any: ...
def registry_dictionary_json(edition: Any = ...) -> Any: ...
def registry_groups_json() -> Any: ...
def registry_inherited_key_names(code: Any) -> Any: ...
def resolve_dict(tran_ags: Any = ..., override_version: Any = ...) -> Any: ...
def run_check(path: Any = ..., text: Any = ..., data: Any = ..., dict_version: Any = ..., include_warnings: Any = ..., include_fyi: Any = ..., check_files: Any = ..., encoding: Any = ...) -> Any: ...
def transport_lock(src: Any, dest: Any, password: Any, level: Any = ..., log_n: Any = ...) -> Any: ...
def transport_lock_bytes(data: Any, password: Any, level: Any = ..., log_n: Any = ...) -> Any: ...
def transport_pack(src: Any, dest: Any, level: Any = ...) -> Any: ...
def transport_pack_bytes(data: Any, level: Any = ...) -> Any: ...
def transport_unlock(src: Any, dest: Any, password: Any) -> Any: ...
def transport_unlock_bytes(data: Any, password: Any) -> Any: ...
def transport_unpack(src: Any, dest: Any) -> Any: ...
def transport_unpack_bytes(data: Any) -> Any: ...
def xlsx_bytes_to_ags4(data: Any, format_numeric_columns: Any = ...) -> Any: ...
class Sidecar:
    @staticmethod
    def assemble(data: Any, edition: Any, checked_at: Any, warnings: Any = ..., fyi: Any = ..., compat: Any = ..., check_files: Any = ..., edition_forced: Any = ...) -> Any: ...
    check_files: Any
    checked_at: Any
    compat: Any
    edition: Any
    ...
    fyi: Any
    def index(self) -> Any: ...
    def is_fresh_for(self, data: Any) -> Any: ...
    last_modified: Any
    def matches_native_validator(self) -> Any: ...
    order: Any
    def profile_covers(self, check_files: Any, forced_edition: Any = ...) -> Any: ...
    sha256: Any
    size: Any
