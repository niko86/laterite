...
def ags4_bytes_to_xlsx(
    data: Any,
    ordered_keys: Any = ...,
    recover_duplicate_headings: Any = ...,
    truncate_excess_fields: Any = ...,
) -> Any: ...
def ags4_to_excel(
    input_file: Any, output_file: Any, ordered_keys: Any = ...
) -> Any: ...
...
def emit_ags4_compat_to_path(tables: Any, path: Any) -> Any: ...
def emit_ags4_from_arrow(
    tables: Any,
    edition: Any = ...,
    mode: Any = ...,
    units: Any = ...,
...
def emit_ags4_from_arrow_unchecked(
    tables: Any, edition: Any = ..., units: Any = ..., types: Any = ...
) -> Any: ...
...
def read_groups_raw(
    path: Any, recover_duplicate_headings: Any = ..., truncate_excess_fields: Any = ...
) -> Any: ...
...
def registry_missing_tran_modes() -> Any: ...
def registry_type_clash_modes() -> Any: ...
def render_read_csv(headings: Any, rows: Any) -> Any: ...
def render_read_json(headings: Any, rows: Any) -> Any: ...
...
def staged_write(path: Any, data: Any) -> Any: ...
def transport_lock(
    src: Any, dest: Any, password: Any, level: Any = ..., log_n: Any = ...
) -> Any: ...
def transport_lock_bytes(
    data: Any, password: Any, level: Any = ..., log_n: Any = ...
) -> Any: ...
