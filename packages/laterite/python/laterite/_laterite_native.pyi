...
def list_rules() -> Any: ...
def merge_files(files: Any, on_type_clash: Any = ..., dict_version: Any = ..., encoding: Any = ..., tran_issue: Any = ..., tran_date: Any = ..., tran_producer: Any = ..., tran_recipient: Any = ..., tran_status: Any = ...) -> Any: ...
...
def registry_editions() -> Any: ...
def registry_fallback_edition() -> Any: ...
...
def resolve_encoding_label(label: Any) -> Any: ...
def run_check(path: Any = ..., text: Any = ..., data: Any = ..., dict_version: Any = ..., include_warnings: Any = ..., include_fyi: Any = ..., check_files: Any = ..., encoding: Any = ..., cert: Any = ...) -> Any: ...
...
class Sidecar:
    ...
    last_modified: Any
    @staticmethod
    def mint(data: Any, checked_at: Any, dict_version: Any = ..., encoding: Any = ..., compat: Any = ...) -> Any: ...
    order: Any
    sha256: Any
    size: Any
