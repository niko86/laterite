...
// truth, rust-packages/ags5-core/data/ags5_dictionary.json. The web copy is a
...
const src = path.resolve(here, "../../rust-packages/ags5-core/data/ags5_dictionary.json");
