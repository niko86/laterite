...
// truth, rust-packages/laterite-core/data/ags5_dictionary.json. The web copy is a
...
const src = path.resolve(here, "../../rust-packages/laterite-core/data/ags5_dictionary.json");
