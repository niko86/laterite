...
FAMILIES: list[tuple[str, str]] = [
    ...
    (
        ...
        "Holes, construction, drilling records & samples",
    ),
    (
        "Ground Description & Field Logging",
        "Geological descriptions, strata, weathering & discontinuities",
    ),
    (
        "In-Situ Penetration & Strength Tests",
        "SPT, CPT, probing, vane & in-situ density",
    ),
    (
        "In-Situ Loading, Deformation & Geophysics",
        "Pressuremeter, dilatometer, plate, seismic & geophysics",
    ),
    (
        "Groundwater & Monitoring",
        "Permeability, pumping, water strikes & installations",
    ),
    (
        "Soil Classification & Index Tests",
        "Atterberg, moisture, density, particle size & index",
    ),
    (
        "Soil Strength, Consolidation & Deformation Tests",
        "Triaxial, shear box, oedometer & consolidation",
    ),
    ("Rock Testing", "Intact-rock strength, density, hardness & abrasiveness"),
    (
        "Aggregate, Earthworks & Pavement Materials",
        "Aggregate suite, CBR, compaction, MCV & lime",
    ),
    (
        "Geoenvironmental & Chemical Testing",
        "Contamination, ground chemistry & corrosivity",
    ),
