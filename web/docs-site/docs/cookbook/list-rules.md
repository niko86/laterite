...
=== "Python"
    ...
    Filter the list the same way you'd filter any list of dicts. For example,
    to keep just the mechanically-fixable rules:
...
=== "CLI"
    ...
    `lat rules` prints the whole catalogue as a table, with no file
    needed:
