...
laterite is [in beta](reference/support.md): what it lacks is real-world use, and
the only way to change that is for people to run it against files we have never
seen.
