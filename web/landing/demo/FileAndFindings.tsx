...
const SEVERITY_CLASS: Record<string, string> = {
  error: "border-err/40 bg-err-quiet text-err",
...
const FindingRow: Component<{ finding: Finding }> = (props) => (
  <li>
    ...
    >
      <span class="font-semibold">{props.finding.rule}</span>
      <Show when={props.finding.line !== null}>
        <span class="ml-2 font-mono text-micro opacity-70">
          line {props.finding.line}
        </span>
      </Show>
      <span class="mt-1 block font-normal">{props.finding.desc}</span>
    </button>
  </li>
);
    ...
    <div style={{ "--band": `var(${props.band})` }}>
      ...
      <Show when={fixNote()}>
        ...
        >
          ...
          sample reference is wrong or the sample is missing. That is the whole
