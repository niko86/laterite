...
📖 **[Documentation](https://laterite.dev/docs/)** · 🌐 **[Browser validator + data explorer](https://laterite.dev/)** · 📓 **[Cookbook](https://laterite.dev/docs/cookbook/)**
...
|---|---|---|---|
| **Python** | `pip install laterite` | polars frames, the typed graph, the `python-ags4` drop-in | [guide](https://laterite.dev/docs/surfaces/python/) |
| **Node.js** | `npm install laterite` | apache-arrow tables, server-side validation | [guide](https://laterite.dev/docs/node/) |
| **CLI — `lat`** | [Releases](https://github.com/niko86/laterite/releases), or `pip install laterite` / `npx laterite` | pipelines, CI gates, one-off checks | [guide](https://laterite.dev/docs/surfaces/cli/) |
| **DuckDB** | `INSTALL laterite_ags4 FROM community;` | SQL straight over `.ags` files, no conversion step | [guide](https://laterite.dev/docs/duckdb/) |
| **Browser** | `npm i @laterite/ags4-wasm` | validate + explore in the page, nothing uploaded anywhere | [guide](https://laterite.dev/docs/reference/wasm-api/) |

All five are **[in beta](https://laterite.dev/docs/reference/support/)** —
...
The **[web app](https://laterite.dev/)** is built on the browser package
...
The [cookbook](https://laterite.dev/docs/cookbook/) shows each task
